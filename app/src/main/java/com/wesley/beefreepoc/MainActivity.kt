...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        storageRepository = StorageRepository(SharedPreferencesKeyValueStorage(this))
        onboardingCompleted = storageRepository.isOnboardingCompleted()
            ...
            BeeFreePOCTheme {
                if (onboardingCompleted) {
                    ...
                    OnboardingScreen(onFinish = {
                        storageRepository.saveOnboardingCompleted(true)
