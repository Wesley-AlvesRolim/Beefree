...
class OnboardingScreenTest {
    ...
    fun onboarding_navigation_flow_ppu_test() {
        ...
        composeTestRule.onNodeWithText(context.getString(R.string.onboarding_welcome_cta)).performClick()
        ...
        composeTestRule.onNodeWithText(context.getString(R.string.onboarding_finish_cta)).performClick()
